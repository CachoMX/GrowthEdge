...
export default function LogoScroll() {
  // Split logos into two halves for two-row display
  const midPoint = Math.ceil(logos.length / 2);
  const topRow = logos.slice(0, midPoint);
  const bottomRow = logos.slice(midPoint);

  return (
    <section className="py-2 md:py-4 px-4 overflow-hidden" style={{ background: 'linear-gradient(to bottom, rgba(90, 138, 199, 0.12) 0%, rgba(90, 138, 199, 0.06) 60%, white 100%)' }}>
